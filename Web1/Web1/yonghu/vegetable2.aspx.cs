...
{
    public partial class vegetable2 : System.Web.UI.Page
    {
        DataTable mytable;
        Database db;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (myRow["FCATEGORY"].ToString().Trim() == "2")
                {
                    Panel p1 = new Panel();
                    p1.Width = 250;
                    p1.Height = 230;
                    ...
                    im.ImageUrl = myRow["VIMAGE"].ToString();
                    im.ID = myRow["VNO"].ToString();
                    im.Click += new ImageClickEventHandler(Button3_Click);
                    im.Width = 250;
                    im.Height = 200;
                    Label la = new Label();
                    la.Text = "购买数量:";
                    ...
                    tt.Width = 40;
                    tt.ID = myRow["VNAME"].ToString();
                    Label la2 = new Label();
                    la2.Text = "   ";
                    Button bt = new Button();
                    bt.Height = 30;
                    bt.ID = myRow["VNAME"].ToString() + "?" + myRow["VIMAGE"].ToString();
        ...
        {
            Response.Redirect("~/yonghu/shicaixingxi.aspx?id=" + ((ImageButton)sender).ID);
        }
    }
}